...
\label{fig:archery3}                        
\end{figure}
\newline Based on the above innformation, answer the following questions :
\begin{enumerate}
\item exactly one of them earns 10 points .
\item both of them earn 10 point.
\end{enumerate}
\item Event A and B are such that \begin{align} P(A) = \dfrac{1}{2},  P(B) = \dfrac{7}{12}\end{align} and \begin{align} P(\bar{A}\cup \bar{B}) = \dfrac{1}{4} \end{align}
...
\item Let X be random variable which assumes values x$_1$, x$_2$, x$_3$, x$_4$  such that   \newline 2P(X = x$_1$) = 3P (X = x$_2$) = P ( X )= x$_3$ = 5P (X = x$_4$).
\newline Find the probability distribution of X.
