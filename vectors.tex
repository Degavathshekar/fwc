...
\begin{center}                                 
\begin{align}sin \dfrac{ \theta}{2} = \dfrac{1}{2} \abs{\overrightarrow{a} - \overrightarrow{b}} \end{align} 
\end{center}
...
\item The Cartesian equation of a line AB is :         
	\begin{center}                                         \begin{align}\dfrac{2x-1}{12} = \dfrac{ y+2}{2} = \dfrac{z-3}{3}\end{align}.                        
\end{center}
...
\item  Find the area of the quadrilateral ABCD whose vertices are $\vec A(-4, -3)$ , $\vec B(3, -1)$, $C(0, 5)$ and $\vec D(-4, 2)$                                         
